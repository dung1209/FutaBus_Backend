...
public class UserApiController {
	...
	public ResponseEntity<Map<String, Object>> checkoutPage(
	        ...
	        @RequestParam(required = false) Integer selectedSeatsCountReturn,
	        ...
	        @RequestParam(required = false) String selectedSeatIdsReturn,
	        ...
	        @RequestParam(required = false) Double totalPriceReturn,
	        @RequestParam(required = false) Long idTripReturn,
	        ...
	        @RequestParam(required = false) Double priceReturn,
	        @RequestParam(required = false) Integer soGheReturn,
	...
	public ResponseEntity<Map<String, Object>> confirmBooking(@RequestBody BookingWrapper wrapper) {
	    ...
	    String idViTriGheStr = go.getIdViTriGhe(); // "1007,1008"
	    ...
	    List<Integer> gheReturnList = Arrays.stream(idViTriGheReturnStr.split(","))
	                                  .map(Integer::parseInt)
	                                  .collect(Collectors.toList());
