...
public String toString() {
	return "ChuyenXe [idChuyenXe=" + idChuyenXe + ", thoiDiemDi=" + thoiDiemDi + ", thoiDiemDen=" + thoiDiemDen
			+ ", giaVe=" + giaVe + ", trangThai=" + trangThai + ", tuyenXe=" + tuyenXe + ", xe=" + xe + ", taiXe="
			+ taiXe + "]";
}

public ChuyenXe(int idChuyenXe, Date thoiDiemDi, Date thoiDiemDen, BigDecimal giaVe, int trangThai, TuyenXe tuyenXe,
		Xe xe, NguoiDung taiXe) {
	super();
	this.idChuyenXe = idChuyenXe;
	this.thoiDiemDi = thoiDiemDi;
	this.thoiDiemDen = thoiDiemDen;
