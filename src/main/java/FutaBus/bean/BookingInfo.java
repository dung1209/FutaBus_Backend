...
public class BookingInfo {
	...
	public String toString() {
		return "BookingInfo [idPhieuDatVe=" + idPhieuDatVe + ", hoTen=" + hoTen + ", soDienThoai=" + soDienThoai
				+ ", email=" + email + ", thoiDiemDi=" + thoiDiemDi + ", thoiDiemDen=" + thoiDiemDen + ", giaVe="
				+ giaVe + ", soLuongVe=" + soLuongVe + ", tongTien=" + tongTien + ", trangThai=" + trangThai
				+ ", thoiGianDatVe=" + thoiGianDatVe + ", tenTuyen=" + tenTuyen + ", benDi=" + benDi + ", benDen="
				+ benDen + ", bienSoXe=" + bienSoXe + ", loaiXe=" + loaiXe + ", danhSachGhe=" + danhSachGhe
				+ ", danhSachIDGhe=" + danhSachIDGhe + "]";
	}

	public BookingInfo(int idPhieuDatVe, String hoTen, String soDienThoai, String email, String thoiDiemDi,
			String thoiDiemDen, double giaVe, int soLuongVe, double tongTien, String trangThai, String thoiGianDatVe,
			String tenTuyen, String benDi, String benDen, String bienSoXe, String loaiXe, String danhSachGhe,
			String danhSachIDGhe) {
		super();
		this.idPhieuDatVe = idPhieuDatVe;
		this.hoTen = hoTen;
		this.soDienThoai = soDienThoai;
